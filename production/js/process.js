...
paragraphs = [`SUBJECT: - Disposal of Enquiry cases based on anonymous/ Pseudonymous complaints 
I am directed to invite attention to this Department circular letter of even number dated 22/7/2011, and state that the following instructions may kindly be brought to the notice of all concerned, noted for strict compliance and may be followed during disposal of anonymous communications:- 
1. Anonymous communications must invariably be filed on their receipt. No action of any kind is to be taken on them and no notice of any kind is to be taken on their contents. If the communication is found to be pseudonymous it (and any previous notes etc. connected with it) must similarly be filed. 
2. It is, however, recognized that there may be exceptional cases, when anonymous/ pseudonymous communication contain allegations of a specific nature having a ring of truth, then these may be inquired into only after obtaining the orders of Administrative Secretaries/Head of Attached Department/ Commissioners/ Deputy Commissioners, as the case may be. 
3. Local heads of Police officers in the Districts can also exercise discretion to order enquiries into anonymous and pseudonymous petition on the analogy of Deputy Commissioners in their respective jurisdictions. Since the Deputy Commissioner is the General Administrative head of the District, his orders should be obtained by the concerned head of office under his administrative control if he wants to take action on any anonymous petition. 
4. Anonymous petitions or letters should normally be filed except when definite allegations are made and concrete instances given. 
5. In complaint against a civil servant, the petitioner should be asked to furnish an affidavit to the effect that all facts stated in his complaint are true and if his affidavit is proved false, he would be prepared to face legal action which could be taken against him.
6. Complaints received through anonymous/pseudonymous source should be ignored. 
7. Antecedents and credentials of a complaint should be verified before an inquiry is instituted against the officials concerned. 8. Newspapers publishing allegations, which are proved to be baseless, should be dealt with according to the law. It is requested that strict observance of the above instructions may be ensured at all levels.
.`];
    ...
    login: function(){
      ...
      if(this.email == "" || this.password == "" || this.otp == ""){
        ...
        this.loading = false;
         ...
         showModal("Wait !", "Exam Password You Entered Is Not Valid !"); 
      }else {
        this.$http.post("./api_backend/login.php", JSON.stringify({cnic: this.email, rollno: this.password, otp: this.otp}))
            .then(response => {
            this.loading = false;
          if(response.body == "notfound"){
            showModal("NOT TODAY !", "Unable to Login");
          }else{
